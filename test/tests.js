...
describe("Single Square Move Generation", function() {
  ...
  var positions = [
    ...
    {fen: '8/7K/8/8/1R6/k7/1R1p4/8 b - - 0 1',
      ...
      moves:
        [{check:false, checkMate:false, color:'b', from:'d2', to:'d1', flags:'np', piece:'p', promotion:'q', san:'d1=Q'},
         {check:false, checkMate:false, color:'b', from:'d2', to:'d1', flags:'np', piece:'p', promotion:'r', san:'d1=R'},
         {check:false, checkMate:false, color:'b', from:'d2', to:'d1', flags:'np', piece:'p', promotion:'b', san:'d1=B'},
         {check:false, checkMate:false, color:'b', from:'d2', to:'d1', flags:'np', piece:'p', promotion:'n', san:'d1=N'}]
    }, // verbose
...
describe("Validate FEN", function() {
  ...
  var positions = [
    ...
    {fen: 'r1bqkbnr/2pppppp/n7/1p6/8/4P3/PPPP1PPP/RNBQK1NR b KQkq b6 0 4', errorNumber: 11},
    {fen: 'rnbqkbnr/1p1ppppp/B1p5/8/6P1/4P3/PPPP1P1P/RNBQK1NR w KQkq g3 0 3', errorNumber: 11},
...
describe("History", function() {
  ...
  var tests = [
     ...
     {verbose: true,
      fen: '4q2k/2r1r3/4PR1p/p1p5/P1Bp1Q1P/1P6/6P1/6K1 b - - 4 41',
      moves: [
        {check:false, checkMate:false, color: 'w', from: 'c2', to: 'c4', flags: 'b', piece: 'p', san: 'c4'},
        {check:false, checkMate:false, color: 'b', from: 'e7', to: 'e6', flags: 'n', piece: 'p', san: 'e6'},
        {check:false, checkMate:false, color: 'w', from: 'g1', to: 'f3', flags: 'n', piece: 'n', san: 'Nf3'},
        {check:false, checkMate:false, color: 'b', from: 'd7', to: 'd5', flags: 'b', piece: 'p', san: 'd5'},
        {check:false, checkMate:false, color: 'w', from: 'd2', to: 'd4', flags: 'b', piece: 'p', san: 'd4'},
        {check:false, checkMate:false, color: 'b', from: 'g8', to: 'f6', flags: 'n', piece: 'n', san: 'Nf6'},
        {check:false, checkMate:false, color: 'w', from: 'b1', to: 'c3', flags: 'n', piece: 'n', san: 'Nc3'},
        {check:false, checkMate:false, color: 'b', from: 'f8', to: 'e7', flags: 'n', piece: 'b', san: 'Be7'},
        {check:false, checkMate:false, color: 'w', from: 'c1', to: 'g5', flags: 'n', piece: 'b', san: 'Bg5'},
        {check:false, checkMate:false, color: 'b', from: 'e8', to: 'g8', flags: 'k', piece: 'k', san: 'O-O'},
        {check:false, checkMate:false, color: 'w', from: 'e2', to: 'e3', flags: 'n', piece: 'p', san: 'e3'},
        {check:false, checkMate:false, color: 'b', from: 'h7', to: 'h6', flags: 'n', piece: 'p', san: 'h6'},
        {check:false, checkMate:false, color: 'w', from: 'g5', to: 'h4', flags: 'n', piece: 'b', san: 'Bh4'},
        {check:false, checkMate:false, color: 'b', from: 'b7', to: 'b6', flags: 'n', piece: 'p', san: 'b6'},
        {check:false, checkMate:false, color: 'w', from: 'c4', to: 'd5', flags: 'c', piece: 'p', captured: 'p', san: 'cxd5'},
        {check:false, checkMate:false, color: 'b', from: 'f6', to: 'd5', flags: 'c', piece: 'n', captured: 'p', san: 'Nxd5'},
        {check:false, checkMate:false, color: 'w', from: 'h4', to: 'e7', flags: 'c', piece: 'b', captured: 'b', san: 'Bxe7'},
        {check:false, checkMate:false, color: 'b', from: 'd8', to: 'e7', flags: 'c', piece: 'q', captured: 'b', san: 'Qxe7'},
        {check:false, checkMate:false, color: 'w', from: 'c3', to: 'd5', flags: 'c', piece: 'n', captured: 'n', san: 'Nxd5'},
        {check:false, checkMate:false, color: 'b', from: 'e6', to: 'd5', flags: 'c', piece: 'p', captured: 'n', san: 'exd5'},
        {check:false, checkMate:false, color: 'w', from: 'a1', to: 'c1', flags: 'n', piece: 'r', san: 'Rc1'},
        {check:false, checkMate:false, color: 'b', from: 'c8', to: 'e6', flags: 'n', piece: 'b', san: 'Be6'},
        {check:false, checkMate:false, color: 'w', from: 'd1', to: 'a4', flags: 'n', piece: 'q', san: 'Qa4'},
        {check:false, checkMate:false, color: 'b', from: 'c7', to: 'c5', flags: 'b', piece: 'p', san: 'c5'},
        {check:false, checkMate:false, color: 'w', from: 'a4', to: 'a3', flags: 'n', piece: 'q', san: 'Qa3'},
        {check:false, checkMate:false, color: 'b', from: 'f8', to: 'c8', flags: 'n', piece: 'r', san: 'Rc8'},
        {check:false, checkMate:false, color: 'w', from: 'f1', to: 'b5', flags: 'n', piece: 'b', san: 'Bb5'},
        {check:false, checkMate:false, color: 'b', from: 'a7', to: 'a6', flags: 'n', piece: 'p', san: 'a6'},
        {check:false, checkMate:false, color: 'w', from: 'd4', to: 'c5', flags: 'c', piece: 'p', captured: 'p', san: 'dxc5'},
        {check:false, checkMate:false, color: 'b', from: 'b6', to: 'c5', flags: 'c', piece: 'p', captured: 'p', san: 'bxc5'},
        {check:false, checkMate:false, color: 'w', from: 'e1', to: 'g1', flags: 'k', piece: 'k', san: 'O-O'},
        {check:false, checkMate:false, color: 'b', from: 'a8', to: 'a7', flags: 'n', piece: 'r', san: 'Ra7'},
        {check:false, checkMate:false, color: 'w', from: 'b5', to: 'e2', flags: 'n', piece: 'b', san: 'Be2'},
        {check:false, checkMate:false, color: 'b', from: 'b8', to: 'd7', flags: 'n', piece: 'n', san: 'Nd7'},
        {check:false, checkMate:false, color: 'w', from: 'f3', to: 'd4', flags: 'n', piece: 'n', san: 'Nd4'},
        {check:false, checkMate:false, color: 'b', from: 'e7', to: 'f8', flags: 'n', piece: 'q', san: 'Qf8'},
        {check:false, checkMate:false, color: 'w', from: 'd4', to: 'e6', flags: 'c', piece: 'n', captured: 'b', san: 'Nxe6'},
        {check:false, checkMate:false, color: 'b', from: 'f7', to: 'e6', flags: 'c', piece: 'p', captured: 'n', san: 'fxe6'},
        {check:false, checkMate:false, color: 'w', from: 'e3', to: 'e4', flags: 'n', piece: 'p', san: 'e4'},
        {check:false, checkMate:false, color: 'b', from: 'd5', to: 'd4', flags: 'n', piece: 'p', san: 'd4'},
        {check:false, checkMate:false, color: 'w', from: 'f2', to: 'f4', flags: 'b', piece: 'p', san: 'f4'},
        {check:false, checkMate:false, color: 'b', from: 'f8', to: 'e7', flags: 'n', piece: 'q', san: 'Qe7'},
        {check:false, checkMate:false, color: 'w', from: 'e4', to: 'e5', flags: 'n', piece: 'p', san: 'e5'},
        {check:false, checkMate:false, color: 'b', from: 'c8', to: 'b8', flags: 'n', piece: 'r', san: 'Rb8'},
        {check:false, checkMate:false, color: 'w', from: 'e2', to: 'c4', flags: 'n', piece: 'b', san: 'Bc4'},
        {check:false, checkMate:false, color: 'b', from: 'g8', to: 'h8', flags: 'n', piece: 'k', san: 'Kh8'},
        {check:false, checkMate:false, color: 'w', from: 'a3', to: 'h3', flags: 'n', piece: 'q', san: 'Qh3'},
        {check:false, checkMate:false, color: 'b', from: 'd7', to: 'f8', flags: 'n', piece: 'n', san: 'Nf8'},
        {check:false, checkMate:false, color: 'w', from: 'b2', to: 'b3', flags: 'n', piece: 'p', san: 'b3'},
        {check:false, checkMate:false, color: 'b', from: 'a6', to: 'a5', flags: 'n', piece: 'p', san: 'a5'},
        {check:false, checkMate:false, color: 'w', from: 'f4', to: 'f5', flags: 'n', piece: 'p', san: 'f5'},
        {check:false, checkMate:false, color: 'b', from: 'e6', to: 'f5', flags: 'c', piece: 'p', captured: 'p', san: 'exf5'},
        {check:false, checkMate:false, color: 'w', from: 'f1', to: 'f5', flags: 'c', piece: 'r', captured: 'p', san: 'Rxf5'},
        {check:false, checkMate:false, color: 'b', from: 'f8', to: 'h7', flags: 'n', piece: 'n', san: 'Nh7'},
        {check:false, checkMate:false, color: 'w', from: 'c1', to: 'f1', flags: 'n', piece: 'r', san: 'Rcf1'},
        {check:false, checkMate:false, color: 'b', from: 'e7', to: 'd8', flags: 'n', piece: 'q', san: 'Qd8'},
        {check:false, checkMate:false, color: 'w', from: 'h3', to: 'g3', flags: 'n', piece: 'q', san: 'Qg3'},
        {check:false, checkMate:false, color: 'b', from: 'a7', to: 'e7', flags: 'n', piece: 'r', san: 'Re7'},
        {check:false, checkMate:false, color: 'w', from: 'h2', to: 'h4', flags: 'b', piece: 'p', san: 'h4'},
        {check:false, checkMate:false, color: 'b', from: 'b8', to: 'b7', flags: 'n', piece: 'r', san: 'Rbb7'},
        {check:false, checkMate:false, color: 'w', from: 'e5', to: 'e6', flags: 'n', piece: 'p', san: 'e6'},
        {check:false, checkMate:false, color: 'b', from: 'b7', to: 'c7', flags: 'n', piece: 'r', san: 'Rbc7'},
        {check:false, checkMate:false, color: 'w', from: 'g3', to: 'e5', flags: 'n', piece: 'q', san: 'Qe5'},
        {check:false, checkMate:false, color: 'b', from: 'd8', to: 'e8', flags: 'n', piece: 'q', san: 'Qe8'},
        {check:false, checkMate:false, color: 'w', from: 'a2', to: 'a4', flags: 'b', piece: 'p', san: 'a4'},
        {check:false, checkMate:false, color: 'b', from: 'e8', to: 'd8', flags: 'n', piece: 'q', san: 'Qd8'},
        {check:false, checkMate:false, color: 'w', from: 'f1', to: 'f2', flags: 'n', piece: 'r', san: 'R1f2'},
        {check:false, checkMate:false, color: 'b', from: 'd8', to: 'e8', flags: 'n', piece: 'q', san: 'Qe8'},
        {check:false, checkMate:false, color: 'w', from: 'f2', to: 'f3', flags: 'n', piece: 'r', san: 'R2f3'},
        {check:false, checkMate:false, color: 'b', from: 'e8', to: 'd8', flags: 'n', piece: 'q', san: 'Qd8'},
        {check:false, checkMate:false, color: 'w', from: 'c4', to: 'd3', flags: 'n', piece: 'b', san: 'Bd3'},
        {check:false, checkMate:false, color: 'b', from: 'd8', to: 'e8', flags: 'n', piece: 'q', san: 'Qe8'},
        {check:false, checkMate:false, color: 'w', from: 'e5', to: 'e4', flags: 'n', piece: 'q', san: 'Qe4'},
        {check:false, checkMate:false, color: 'b', from: 'h7', to: 'f6', flags: 'n', piece: 'n', san: 'Nf6'},
        {check:false, checkMate:false, color: 'w', from: 'f5', to: 'f6', flags: 'c', piece: 'r', captured: 'n', san: 'Rxf6'},
        {check:false, checkMate:false, color: 'b', from: 'g7', to: 'f6', flags: 'c', piece: 'p', captured: 'r', san: 'gxf6'},
        {check:false, checkMate:false, color: 'w', from: 'f3', to: 'f6', flags: 'c', piece: 'r', captured: 'p', san: 'Rxf6'},
        {check:false, checkMate:false, color: 'b', from: 'h8', to: 'g8', flags: 'n', piece: 'k', san: 'Kg8'},
        {check:false, checkMate:false, color: 'w', from: 'd3', to: 'c4', flags: 'n', piece: 'b', san: 'Bc4'},
        {check:false, checkMate:false, color: 'b', from: 'g8', to: 'h8', flags: 'n', piece: 'k', san: 'Kh8'},
        {check:false, checkMate:false, color: 'w', from: 'e4', to: 'f4', flags: 'n', piece: 'q', san: 'Qf4'}],
      fen: '4q2k/2r1r3/4PR1p/p1p5/P1Bp1Q1P/1P6/6P1/6K1 b - - 4 41'}
  ];
